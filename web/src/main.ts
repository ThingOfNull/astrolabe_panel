...
import { loadWidgetSchema } from './api/schema';
...
// Hydrate the widget schema from the backend without blocking the first paint:
// ACCEPTED_SHAPES has a sensible static fallback that covers every known type.
void loadWidgetSchema();
